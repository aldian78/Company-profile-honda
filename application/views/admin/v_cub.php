...
<body class="hold-transition skin-blue sidebar-mini">
                        ...
                        <div class="box">
                            ...
                            <div class="box">
                                <div class="box-header">
                                    <a class="btn btn-success btn-flat" href="<?php echo base_url() . 'admin/cub/add_cub' ?>"><span class="fa fa-plus"></span> Add Super Cub</a>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">
                                    <table id="example1" class="table table-striped" style="font-size:13px;">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    <td><img src="<?php echo base_url() . 'assets/images/supercub/' . $port_gambar; ?>" style="width:90px;"></td>
                                                    <td><?php echo $port_judul; ?></td>

                                                    <td><?php echo $port_tanggal; ?></td>
                                                    <td><?php echo $port_author; ?></td>
                                                    <td style="text-align:right;">
                                                        <a class="btn" href="<?php echo base_url() . 'admin/cub/get_edit/' . $port_id; ?>"><span class="fa fa-pencil"></span></a>
        ...
        <div class="modal fade" id="ModalHapus<?php echo $port_id; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url() . 'admin/cub/hapus_cub' ?>" method="post" enctype="multipart/form-data">
    ...
    <?php if ($this->session->flashdata('msg') == 'success') : ?>
        <script type="text/javascript">
            $.toast({
                heading: 'Success',
                text: "Produk Super cub Berhasil disimpan ke database.",
    ...
    <?php elseif ($this->session->flashdata('msg') == 'info') : ?>
        <script type="text/javascript">
            $.toast({
                heading: 'Info',
                text: "Produk Super cub berhasil di update",
                showHideTransition: 'slide',
                icon: 'info',
                hideAfter: false,
                position: 'bottom-right',
    ...
    <?php elseif ($this->session->flashdata('msg') == 'success-hapus') : ?>
        <script type="text/javascript">
            $.toast({
                heading: 'Success',
                text: "Produk Super cub Berhasil dihapus.",
                showHideTransition: 'slide',
                icon: 'success',
                hideAfter: false,
                position: 'bottom-right',
