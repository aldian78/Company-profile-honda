...
<header class="main-header">
  ...
  <a href="" class="logo">
    ...
    <span class="logo-mini"><img src="<?php echo base_url(); ?>assets/images/logo.png" width="30" height="30"></span>
    <!-- logo for regular state and mobile devices -->
    <span class="logo-lg"><img src="<?php echo base_url(); ?>assets/images/honda.png" width="170" height="60" style="padding-bottom:10px;"></span>
