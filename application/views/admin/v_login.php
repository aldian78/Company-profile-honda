...
<body class="hold-transition login-page">
  <div class="login-box">
    ...
    <div class="login-box-body">
      <p class="login-box-msg"> <img src="<?php echo base_url() . 'assets/images/login.gif' ?>" style="width: 200px; height:100px;"></p>
      <hr />
      ...
      <hr />
      <p>
        <center>Copyright <?php echo '2020' ?> by Aldian | Bicky<br /> All Right Reserved</center>
      </p>
    </div>
    <!-- /.login-box-body -->
  </div>
