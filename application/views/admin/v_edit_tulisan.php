          ...
          <div class="col-md-4">
            <div class="box box-primary">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  <img src="<?php echo base_url(); ?>assets/images/produk/<?php echo $b['tulisan_gambar']; ?>" width="100" alt="" name="gambar" required>
                  <input type="file" name="tulisan_gambar" class="form-control">
                </div>
                <div class="form-group">
                  <img src="<?php echo base_url(); ?>assets/images/produk/<?php echo $b['tulisan_gambar1']; ?>" width="100" alt="" name="gambar">
                  <input type="file" name="tulisan_gambar1" class="form-control">
                </div>
                <div class="form-group">
                  <img src="<?php echo base_url(); ?>assets/images/produk/<?php echo $b['tulisan_gambar2']; ?>" width="100" alt="" name="gambar">
                  <input type="file" name="tulisan_gambar2" class="form-control">
                </div>
                <div class="form-group">
                  <img src="<?php echo base_url(); ?>assets/images/produk/<?php echo $b['tulisan_gambar3']; ?>" width="100" alt="" name="gambar">
                  <input type="file" name="tulisan_gambar3" class="form-control">
                </div>
                <div class="form-group">
                  <img src="<?php echo base_url(); ?>assets/images/produk/<?php echo $b['tulisan_gambar4']; ?>" width="100" alt="" name="gambar">
                  <input type="file" name="tulisan_gambar4" class="form-control">
                </div>
