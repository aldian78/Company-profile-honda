        ...
        <div id="fh5co-grid-products" class="animate-box">
            ...
            ?>
                ...
                <div class="col-md-4 text-center item-block">
                    <a href="#"><img src="<?php echo base_url() . 'assets/images/sport/' . $port_image; ?>"></a>
                    <div class="v-align">
                        <div class="v-align-middle"><br />
                            <h4 class="title" style="color: black;"><?php echo $port_judul; ?></h4>
                            <p><a href="<?php echo base_url() . 'sport/detail/' . $port_id ?>" class="btn btn-primary btn-outline with-arrow">Detail<i class="icon-arrow-right"></i></a></p>
                        </div>
                    </div>
                </div>
            <?php endforeach; ?>
