            ...
            <div class="container">
                ...
                <div class="row">
                                ...
                                <div id="myCarousel" class="carousel slide" data-ride="carousel">
                                    ...
                                    <div class="carousel-inner">
                                        <div class="item active">
                                            <img src="<?php echo base_url() . 'assets/images/supercub/' . $row->port_image1; ?>" alt="" class="img-reponsive">
                                        </div>

                                        <?php if ($row->port_image2 != null) { ?>
                                            <div class="item">
                                                <img src="<?php echo base_url() . 'assets/images/supercub/' . $row->port_image2; ?>" alt="" class="img-reponsive">
                                            </div>
                                        <?php } ?>
                                        <?php if ($row->port_image3 != null) { ?>
                                            <div class="item">
                                                <img src="<?php echo base_url() . 'assets/images/supercub/' . $row->port_image3; ?>" alt="" class="img-reponsive">
                                            </div>
                                        <?php } ?>
                                        <?php if ($row->port_image4 != null) { ?>
                                            <div class="item">
                                                <img src="<?php echo base_url() . 'assets/images/supercub/' . $row->port_image4; ?>" alt="" class="img-reponsive">
                                            </div>
                                        <?php } ?>
                                        <!-- Indicators left & right -->
                    ...
                    <div class="col-md-4">
                        ...
                        <?php endforeach; ?>
                        <br></br>
                        <iframe width="400" height="300" src="https://www.youtube.com/embed/8qZBbXWwmWs" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        <iframe width="400" height="300" src="https://www.youtube.com/embed/sjKesGtuwsw" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    </div>
                </div>
            </div>
        </div>
