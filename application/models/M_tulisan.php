...
class M_tulisan extends CI_Model
{
	...
	function simpan_tulisan($judul, $isi, $kategori_id, $kategori_nama, $user_id, $user_nama, $tulisan_gambar, $tulisan_gambar1, $tulisan_gambar2, $tulisan_gambar3, $tulisan_gambar4)
	{
		$hsl = $this->db->query("insert into tbl_tulisan(tulisan_judul,tulisan_isi,tulisan_kategori_id,tulisan_kategori_nama,tulisan_pengguna_id,tulisan_author,tulisan_gambar,tulisan_gambar1,tulisan_gambar2,tulisan_gambar3,tulisan_gambar4) values ('$judul','$isi','$kategori_id','$kategori_nama','$user_id','$user_nama','$tulisan_gambar','$tulisan_gambar1','$tulisan_gambar2','$tulisan_gambar3','$tulisan_gambar4')");
		return $hsl;
	}
	...
	function update_tulisan($tulisan_id, $judul, $isi, $kategori_id, $kategori_nama, $user_id, $user_nama, $tulisan_gambar, $tulisan_gambar1, $tulisan_gambar2, $tulisan_gambar3, $tulisan_gambar4)
	{
		$hsl = $this->db->query("update tbl_tulisan set tulisan_judul='$judul',tulisan_isi='$isi',tulisan_kategori_id='$kategori_id',tulisan_kategori_nama='$kategori_nama',tulisan_pengguna_id='$user_id',tulisan_author='$user_nama',tulisan_gambar='$tulisan_gambar',tulisan_gambar1='$tulisan_gambar1',tulisan_gambar2='$tulisan_gambar2',tulisan_gambar3='$tulisan_gambar3',tulisan_gambar4='$tulisan_gambar4' where tulisan_id='$tulisan_id'");
		return $hsl;
	}
	...
	function getpeoples($limit, $start)
	{
		return $this->db->get('tbl_tulisan', $limit, $start)->result_array();
	}
	function countAllpeoples()
	{
		return $this->db->get('tbl_tulisan')->num_rows();
	}
	...
	function get_berita_by_id($tulisan_id)
	{
		$hsl = $this->db->query("SELECT tbl_tulisan.*,DATE_FORMAT(tulisan_tanggal,'%d/%m/%Y') AS tanggal FROM tbl_tulisan where tulisan_id='$tulisan_id'");
		return $hsl;
	}
